...
ระบบจองลานกางเต็นท์ผ่าน Web Application ใช้สำหรับจองลานกางเต็นท์  เพื่อเป็นการป้องกันไม่ให้ขยายพื้นที่ตั้งแคมป์ออกไปอีก ของคนที่ยังไม่เคยจองควรหาที่สถานที่ให้ได้ก่อนวันเดินทางหรือก่อนพระอาทิตย์ตกดินอย่างน้อย 1 ชั่วโมง เพื่อจะได้ไม่เสียเวลาในการเดินทาง โดยจะมีการการเก็บข้อมูลชื่อ-สกุล วันเช็คอิน วันเช็คเอาท์ สถานที่ที่จะจองลานกางเต็นท์ จำนวนผู้พัก เบอร์โทรศัพท์ติดต่อ และจะแสดงตารางประวัติการจองซึ่งสามารถเพิ่ม ลบ แก้ไขได้.
